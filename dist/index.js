...
async function swaggerJsonByControls(controllers, { filePath, servers, deepScanRoutes = true, ignoreGlobalPrefix = true, contact, useBearerAuth, title, description, externalDoc, version, tags, } = {}) {
